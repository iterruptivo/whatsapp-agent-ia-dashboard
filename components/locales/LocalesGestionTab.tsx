// ============================================================================
// COMPONENT: LocalesGestionTab (Primer Sub-Tab de Gestión de Locales)
// ============================================================================
// Descripción: Tab principal para gestión de locales con tiempo real
...
interface LocalesGestionTabProps {
...
export default function LocalesGestionTab({
  initialLocales,
  totalLocales,
  proyectos,
  initialStats,
}: LocalesGestionTabProps) {
  // ====== AUTH ======
