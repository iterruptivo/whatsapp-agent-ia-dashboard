    ...
    <header className="bg-secondary shadow-md">
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex items-center justify-between">
          ...
          {/* User Info & Logout Section - ALWAYS render container to avoid hydration mismatch */}
          <div className="flex items-center gap-2 sm:gap-4">
            {isClient && !loading && user ? (
              ...
              // Render invisible placeholder to maintain consistent DOM structure during SSR
              <div className="h-10 w-32 sm:w-48" style={{ visibility: 'hidden' }} aria-hidden="true" />
            )}
          </div>
        </div>
      </div>
