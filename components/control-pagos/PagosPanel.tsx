...
export default function PagosPanel({ isOpen, controlPago, onClose }: PagosPanelProps) {
  ...
  return (
    <>
        ...
        <div className="sticky top-0 bg-[#1b967a] text-white p-6 flex items-center justify-between z-10">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 text-white hover:bg-white/20 px-3 py-2 rounded-lg transition-colors text-sm"
          ...
          <>
            ...
            <div className="p-6 bg-gradient-to-r from-green-50 to-blue-50 border-b">
              <div className="text-center">
                ...
                {/* Botón Constancia de Cancelación - Solo cuando está 100% pagado */}
                {controlPago && (stats?.totalAbonado || 0) >= ((stats?.totalVenta || 0) + (stats?.totalIntereses || 0)) && (
                  <div className="mt-4">
            ...
            {pagoSeparacion && (
              <div className="p-6 bg-white border-b">
                ...
                {/* Botón Constancia de Separación - Solo cuando separación está completada */}
                {pagoSeparacion.estado === 'completado' && controlPago && (
                  <div className="mt-4">
                    <GenerarConstanciaButton
                      controlPagoId={controlPago.id}
                      tipo="separacion"
      ...
      {showExpediente && controlPago && (
        <ExpedienteDigitalPanel
          controlPagoId={controlPago.id}
          localCodigo={controlPago.codigo_local}
          clienteNombre={controlPago.lead_nombre}
