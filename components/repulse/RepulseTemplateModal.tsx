                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            if (textarea) {
                              const start = textarea.selectionStart;
                              const end = textarea.selectionEnd;
                              const newText = mensaje.slice(0, start) + '{{nombre}}' + mensaje.slice(end);
                              setMensaje(newText);
                              setTimeout(() => {
                                textarea.focus();
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            if (textarea) {
                              const start = textarea.selectionStart;
                              const end = textarea.selectionEnd;
                              const newText = mensaje.slice(0, start) + '{{fecha_visita}}' + mensaje.slice(end);
                              setMensaje(newText);
                              setTimeout(() => {
                                textarea.focus();
                              ...
                              setMensaje(prev => prev + '{{fecha_visita}}');
                            }
                          }}
                          className="px-2 py-0.5 text-xs bg-white border border-blue-200 rounded hover:bg-blue-100 text-blue-700"
                        >
