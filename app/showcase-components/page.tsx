...
export default function ShowcaseComponentsPage() {
  ...
  const victoriaData = {
    ...
    victoria_attribution_percent: 28.8,
  };
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Componentes del Dashboard Ejecutivo con datos de ejemplo
          </p>
        </div>

        {/* KPI Cards */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-[#192c4d] mb-4">1. KPI Cards</h2>
          <KPICards summary={summaryData} victoriaData={victoriaData} />
        </div>

        {/* Funnel Chart */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-[#192c4d] mb-4">2. Funnel de Conversión</h2>
          <FunnelChart data={funnelData} />
        </div>

        {/* Pipeline Chart */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-[#192c4d] mb-4">3. Pipeline por Estado</h2>
          <PipelineChart data={pipelineData} />
        </div>

        {/* Canales Table */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-[#192c4d] mb-4">4. Efectividad por Canal</h2>
          <CanalesTable data={canalesData} />
        </div>

        {/* Vendedores Ranking */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-[#192c4d] mb-4">5. Ranking de Vendedores</h2>
          <VendedoresRanking data={vendedoresData} />
        </div>

        {/* Financiero Health */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-[#192c4d] mb-4">6. Salud Financiera</h2>
          <FinancieroHealth
