-- ============================================================================
-- MIGRACIÓN 032: Actualizar trigger de auditoría para incluir piso en locales
-- Fecha: 2026-01-27
-- Descripción: Corrige el trigger para que CAMBIO_LOCAL incluya el piso del local
-- ============================================================================

-- Recrear la función con soporte para piso
...
BEGIN
  ...
  IF TG_OP = 'UPDATE' THEN
    ...
    -- titular_sexo
    IF OLD.titular_sexo IS DISTINCT FROM NEW.titular_sexo THEN
      INSERT INTO fichas_historial (ficha_id, accion, campo, valor_anterior, valor_nuevo, usuario_id, usuario_nombre, usuario_rol, origen)
      VALUES (NEW.id, 'UPDATE', 'titular_sexo', OLD.titular_sexo, NEW.titular_sexo, v_usuario_id, v_usuario_nombre, v_usuario_rol, v_origen);
    END IF;
