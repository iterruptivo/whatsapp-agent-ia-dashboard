-- ============================================================================
-- MIGRACIÓN 034: Corregir trigger de auditoría - remover campo estado
-- Fecha: 2026-01-27
-- Descripción: El campo 'estado' no existe en clientes_ficha pero el trigger
--              lo referencia, causando error al guardar fichas
-- ============================================================================

-- Recrear la función sin referencia a estado ni titular_sexo
...
BEGIN
  ...
  IF TG_OP = 'UPDATE' THEN
    ...
    -- NOTA: titular_sexo fue removido (migración 033) - el campo no existe en clientes_ficha
    ...
    -- NOTA: 'estado' fue removido (migración 034) - el campo no existe en clientes_ficha
